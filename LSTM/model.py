...
class Model(object):
    ...
    def __init__(self, parameters=None, models_path=None, model_path=None):
        ...
        if model_path is None:
            ...
            self.name = "model_MedLine_LSTMchar25_LSTMword100_Dropout0.5_TagIOB_Learn_glove_fixed_mimic_600_20"
            # Model location
    ...
    def build(self,
        ...
        if len(inputs) != 1:
            ...
            print "The shape with char: "+str(type(inputs))
        else:
            inputs=T.concatenate(inputs)
            print "The shape without char: "+str(type(inputs))
