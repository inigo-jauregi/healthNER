...
*Due to the large size of the word embedding files, they have not been provided here. CommonCrawl embeddings are available in the oficial GloVe webpage. In order to obtain the specialized embeddings mentioned in the paper, you need to ask permition to have access to the MIMIC-III database, retrain Glove in that data and concatenate this embedding with the CommonCrawl embeddings.
